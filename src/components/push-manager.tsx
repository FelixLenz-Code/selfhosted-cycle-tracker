      ...
      <div className="flex flex-wrap items-center gap-2">
        {subscribed ? (
          <>
            ...
            <button onClick={test} disabled={busy} className="btn-primary disabled:opacity-60">
              Test senden
            </button>
          </>
        ) : (
          <button onClick={subscribe} disabled={busy} className="btn-primary disabled:opacity-60">
